...
public class MainActivity3 extends AppCompatActivity {
    ...
    setContentView(R.layout.activity_main3);
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (email.isEmpty()) {
                            ...
                            .addOnCompleteListener(MainActivity3.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    ...
                                    if (!task.isSuccessful()) {
                                        CustomToast.createToast(MainActivity3.this,
                    ...
                    CustomToast.createToast(MainActivity3.this, "Error Occurred !", true);
                }
            }
        });
        ...
        tvSignIn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainActivity3.this, SignIn.class);
