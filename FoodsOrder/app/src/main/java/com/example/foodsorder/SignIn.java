...
import com.example.foodsorder.Models.UserDetail;
import com.example.foodsorder.util.CustomToast;
...
public class SignIn extends AppCompatActivity {
    ...
    @Override
        ...
        mAuthStateListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (mFirebaseUser != null) {
                    moveToMainActivity2(mFirebaseUser);
                } else {
                                    ...
                                    new OnCompleteListener<AuthResult>() {
                                        ...
                                        public void onComplete(@NonNull Task<AuthResult> task) {
                                            if (!task.isSuccessful()) {
                                                ...
                                                moveToMainActivity2(task.getResult().getUser());
                                            }
                                        }
                                    });
                } else {
        ...
        tvSignUp.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intSignUp = new Intent(SignIn.this, MainActivity3.class);
    ...
    private void moveToMainActivity2(FirebaseUser mFirebaseUser) {
